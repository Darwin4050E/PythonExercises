...
def is_in(main_list, secondary_list):
    '''Determine if the sequence of elements in main_list is in secondary_list.
    
    :param main_list: list - main list.
    :param seconday_list: list - secondary list.
    :return: bool - if the sequence of elements in main_list is in secondary_list.
    '''
    return any(main_list == secondary_list[index:index + len(main_list)] for index in range(len(secondary_list) - len(main_list) + 1))